...
python train.py --deq --qp_solve --deq_iter 6 --bsz 200 --T 5 --name stab_l2_gcn --env FlyingCartpole --H 1 --hdim 256 --nq 7 --loss_type l2 --layer_type gcn --save #--ckpt deqmpc_FlyingCartpole_swing_l2_T5_bsz200_deq_iter6_hdim256 --eval
